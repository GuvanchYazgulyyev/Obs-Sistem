<%@ Page Title="" Language="C#" MasterPageFile="~/Ana.Master" AutoEventWireup="true" CodeBehind="OgrenciGuncelle.aspx.cs" Inherits="Udemi_Proje_OBS_Sistem.OgrenciGuncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <form id="Form1" runat="server">
        ...
        <div class="form-group">
            ...
            <br />
            <div>
                <asp:Label for="TxtOgrFoto" runat="server"> Öğrenci Fotograf Linki: </asp:Label>
